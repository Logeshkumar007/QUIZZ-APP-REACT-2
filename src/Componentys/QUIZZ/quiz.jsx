      ...
      >
        ...
        <div>
          <h1 className="question">
            {array.length > 0 ? array[submitcount].question : "Loading..."}
          </h1>
          <div className="option">
            <div className="opt1-opt3">
              <Button
                className="option1"
                onClick={() => {
                  setselected("opt1");
                ...
                sx={{
                  ...
                  "&:hover": {
                    backgroundColor: col1,
                    transform: "scale(1.08)", // Change to the desired hover color
                  },
                }}
              >
                1.{" "}
                {array.length > 0 ? array[submitcount].option1 : "Loading..."}
              </Button>
                <br></br>
              <Button
                className="option3"
              ...
              >
                3.{" "}
                {array.length > 0 ? array[submitcount].option3 : "Loading..."}
              </Button>
            </div>
            <div className="opt2-opt4">
              <Button
                className="option2"
                onClick={() => {
                  setselected("opt2");
              ...
              >
                2.{" "}
                {array.length > 0 ? array[submitcount].option2 : "Loading..."}
              </Button>
                  <br></br>
              ...
              >
                4.{" "}
                {array.length > 0 ? array[submitcount].option4 : "Loading..."}
              </Button>
            </div>
          </div>
          <Button
